...
%-------------------------------------------------------------------------------
\name{Hannah}{Howard}
\position{Senior Developer{\enskip\cdotp\enskip}Code Teacher}
\address{1615 S. Wilton Pl, Los Angeles, CA 90019}

\mobile{818-312-3967}
\email{hannah@techgirlwonder.com}
\github{hannahhoward}
\linkedin{techgirlwonder}
% \stackoverflow{SO-id}{SO-name}
\twitter{@techgirlwonder}
% \skype{skype-id}
% \reddit{reddit-id}
